...
class ProductCategoryController extends Controller
{
    ...
    */
    public function index()
    {
        ...
        return view('manager.product-category.index', compact('categories'));
    }
    ...
    */
    ...
    {
        $categories = ProductCategory::all();
        return view("manager.product-category.add", compact("categories"));
    }
    ...
    */
    public function store(Request $request)
    {
        ...
        $category->save();
        return redirect("m1001m/product-categories")->with("success", "A category has been saved successfully");
    }
    ...
    */
    public function edit($id)
    {
        ...
        $categories = ProductCategory::all();
        return view("manager.product-category.edit", compact("category", "categories"));
    }
    ...
    */
    public function update(Request $request, $id)
    {
        ...
        $category->save();
        return redirect("m1001m/product-categories")->with("success", "A category has been updated successfully");
    }
