...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ url('a1aa/product-groups') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="number" min="0" name="manager_salary" id="manager_salary" class="form-control"
                                    placeholder="Enter the salary in rubles">
                            </div>
                            <div class="col-lg-6">
