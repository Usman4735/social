            ...
            <div class="content-body">
                <div class="auth-wrapper auth-basic px-2">
                    <div class="auth-inner my-2">
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="{{ url('m1001m') }}" class="brand-logo">
                                ...
                                <h4 class="card-title mb-1 text-center">Manager</h4>
                                ...
                                @endif
                                <form class="auth-login-form mt-2" id="form" action="{{ url('m1001m') }}"
                                    method="POST">
                                    @csrf
                                    <div class="mb-1">
                                    ...
                                    <div class="mb-1">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <a href="{{ url('m1001m/forgot-password') }}">
