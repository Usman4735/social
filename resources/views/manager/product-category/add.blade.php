...
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ url('m1001m/product-categories') }}">Product Categories</a></li>
...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ url('m1001m/product-categories') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
