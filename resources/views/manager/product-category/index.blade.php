            ...
            <div class="card">
                <div class="card-header row">
                    <div class="col-12 text-end">
                        <a href="{{ url('m1001m/product-categories/create') }}" class="btn btn-primary btn-sm mr-2"
                        ...
                        <tbody>
                            @foreach ($categories as $category)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('m1001m/product-categories') }}/{{ encrypt($category->id) }}/edit"
                                            class="btn btn-primary btn-sm"><i
                                                data-feather="edit"></i></a>
                                        <form class="d-inline-block delete-btn"
                                            action="{{ url('m1001m/product-categories') }}/{{ encrypt($category->id) }}"
                                            method="post">
                                            @csrf
                                            @method('delete')
