 ...
 <form action="{{ url('sa1991as/gallery') }}/{{ encrypt($media_gallery->id) }}" method="post"
     ...
     <div class="row">
         ...
         <div class="col-lg-12">
             ...
             <div class="col-sm-12">
                 <input type="text" class="form-control" value="{{ $media_gallery->alt }}" name="alt"
                     id="alt">
             </div>
         </div>
         <div class="col-lg-12">
             <label for="description" class="col-form-label">Description</label>
             <input type="text" class="form-control" value="{{ $media_gallery->description }}" name="description"
                 id="description">
         </div>
     </div>
     <div class="row">
