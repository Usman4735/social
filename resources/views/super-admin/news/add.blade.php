                    ...
                    <form action="{{ url('sa1991as/news') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <textarea name="short_description" id="short_description" class="form-control form-control-sm" required></textarea>
                            </div>
                            <div class="col-lg-12">
                                <label for="long_description" class="col-form-label">Long Description</label>
                                <textarea name="long_description" id="long_description" class="form-control form-control-sm"></textarea>
                            </div>
                        </div>
                        <div class="row mt-3">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control form-control-sm" name="seo_url" id="seo_url" required>
                                </div>
                            </div>
                            <div class="col-lg-6">
