                    ...
                    <form action="{{ url('sa1991as/news') }}/{{ encrypt($news->id) }}" method="post"
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" name="seo_title"  value="{{ $news->seo_title }}" id="seo_title">
                                </div>
                            </div>
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" name="seo_h1" value="{{ $news->seo_h1 }}" id="seo_h1">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <label for="seo_keyword" class="col-sm-2 col-form-label">Keywords</label>
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" name="seo_keyword" value="{{ $news->seo_keyword }}" id="seo_keyword">
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <label for="seo_description" class="col-sm-2 col-form-label">Description</label>
                                <div class="col-sm-12">
                                    <textarea name="seo_description" id="seo_description" class="form-control" rows="3">{{ $news->seo_description }}</textarea>
                                </div>
                            </div>
