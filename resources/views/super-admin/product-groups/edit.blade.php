...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ url('sa1991as/product-groups') }}/{{encrypt($product->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="card-title my-3">Manager Permissions</div>
                                <div class="col-12">
                                        ...
                                        <tbody>
                                            @foreach ($managers as $manager)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="button" title="Manager Permissions" url="{{ url('sa1991as/product-groups/permissions') }}/{{$manager->id}}/{{$product->id}}" size="modal-lg"
                                                            class="btn btn-primary btn-sm modal_popup">Permissions</button>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
