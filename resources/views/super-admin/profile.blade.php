                            ...
                            <form action="{{ url('sa1991as/profile') }}" method="POST" enctype="multipart/form-data" id="form">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input name="mobile" type="text" class="form-control form-control-sm" id="mobile"
                                    ...
                                    <div class="col-lg-12">
                                        <label for="username" class="col-form-label">Username <span
                                                class="text-danger">*</span></label>
                                        <input required name="username" type="text" class="form-control form-control-sm" id="username"
                                    ...
                                    <div class="col-lg-6">
                                        <label for="confirm_password" class="col-form-label">Confirm Password <span
                                                class="text-danger">*</span></label>
                                        <input name="confirm_password" type="password" class="form-control form-control-sm"
