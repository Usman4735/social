                                ...
                                <form action="{{ url('login') }}" method="post">
                                    ...
                                    <div class="login-form">
                                        ...
                                        <div class="single-login">
                                            ...
                                            <input type="text" required name="order_id" class="form-control form-control-sm"
                                                placeholder="Please Enter Order ID" value="{{ old('order_id') }}"
                                                autocomplete="false" autofocus>
                                        </div>
                                        <div class="single-login">
                                            <label>Payment ID <span>*</span></label>
                                            <input type="text" required name="payment_id" class="form-control form-control-sm"
